...
export const TRANSLATION_KEYS = {
	...
	propertyDetail: {
		...
		aboutThisProperty: "propertyDetail.aboutThisProperty",
		propertyFeatures: "propertyDetail.propertyFeatures",
		// Feature items
		marinaViews: "propertyDetail.marinaViews",
		undergroundParking: "propertyDetail.undergroundParking",
		airConditioning: "propertyDetail.airConditioning",
		liftAccess: "propertyDetail.liftAccess",
		concierge24h: "propertyDetail.concierge24h",
		wineFridge: "propertyDetail.wineFridge",
		securitySystem: "propertyDetail.securitySystem",
		largeTerrace: "propertyDetail.largeTerrace",
		storageRoom: "propertyDetail.storageRoom",
		doubleGlazing: "propertyDetail.doubleGlazing",
		frontLineLocation: "propertyDetail.frontLineLocation",
		communalPool: "propertyDetail.communalPool",
		underfloorHeating: "propertyDetail.underfloorHeating",
		fiberInternet: "propertyDetail.fiberInternet",
		// Location text
		locationDescription: "propertyDetail.locationDescription",
		inTheHeartOf: "propertyDetail.inTheHeartOf",
		offeringEasyAccess: "propertyDetail.offeringEasyAccess",
		localAmenities: "propertyDetail.localAmenities",
		beachesAndAttractions: "propertyDetail.beachesAndAttractions",
	},
	...
	dashboard: {
		...
		// Loading states
		loadingFavorites: "dashboard.loadingFavorites",
		loadingRecentlyViewed: "dashboard.loadingRecentlyViewed",
		// Empty state descriptions (expanded)
		noFavouritesDescriptionFull: "dashboard.noFavouritesDescriptionFull",
		browseProperties: "dashboard.browseProperties",
		yourCustomSearchFilters: "dashboard.yourCustomSearchFilters",
		noSavedSearchesDescriptionFull: "dashboard.noSavedSearchesDescriptionFull",
		createASearch: "dashboard.createASearch",
		propertiesYouLookedAt: "dashboard.propertiesYouLookedAt",
		noRecentViewsDescriptionFull: "dashboard.noRecentViewsDescriptionFull",
		// Messages tab
		compareMessageLayouts: "dashboard.compareMessageLayouts",
		chooseLayoutPreference: "dashboard.chooseLayoutPreference",
		message1Sections: "dashboard.message1Sections",
		message2SubTabs: "dashboard.message2SubTabs",
		message3Feed: "dashboard.message3Feed",
		// Sell property tab
		listPropertyWithUs: "dashboard.listPropertyWithUs",
		readyToSellOrRent: "dashboard.readyToSellOrRent",
		getPropertyInFront: "dashboard.getPropertyInFront",
		contactTeamAdvertising: "dashboard.contactTeamAdvertising",
		contactUs: "dashboard.contactUs",
		// Settings tab
		accountSettings: "dashboard.accountSettings",
		manageYourAccount: "dashboard.manageYourAccount",
		personalInformation: "dashboard.personalInformation",
		updateProfileDetails: "dashboard.updateProfileDetails",
		fullName: "dashboard.fullName",
		email: "dashboard.email",
		phone: "dashboard.phone",
		addPhoneNumber: "dashboard.addPhoneNumber",
		saveChanges: "dashboard.saveChanges",
		notifications: "dashboard.notifications",
		manageNotificationPreferences: "dashboard.manageNotificationPreferences",
		emailNotifications: "dashboard.emailNotifications",
		receiveUpdatesNewProperties: "dashboard.receiveUpdatesNewProperties",
		priceAlerts: "dashboard.priceAlerts",
		notifiedPriceChanges: "dashboard.notifiedPriceChanges",
		newListings: "dashboard.newListings",
		alertNewProperties: "dashboard.alertNewProperties",
