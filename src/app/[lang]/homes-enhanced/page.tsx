          ...
          <div className="px-4 py-3 border-b bg-white dark:bg-gray-800">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                {count} {count === 1 ? t("listings.property") : t("listings.properties")}
              </h2>
              {selectedCity && (
                <span className="text-sm text-gray-600 dark:text-gray-400">
                  {t("listings.inCity")} {selectedCity}
                </span>
              )}
            </div>
          </div>
            ...
            {isLoading && properties.length === 0 ? (
              <div className="flex items-center justify-center h-64">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">{t("listings.loadingProperties")}</p>
                </div>
              </div>
            ) : properties.length === 0 ? (
              <div className="flex items-center justify-center h-64">
                <div className="text-center">
                  <p className="text-gray-600 dark:text-gray-400 mb-2">{t("listings.noPropertiesFound")}</p>
                  <p className="text-sm text-gray-500">{t("listings.tryAdjustingFilters")}</p>
                </div>
              </div>
            ) : (
